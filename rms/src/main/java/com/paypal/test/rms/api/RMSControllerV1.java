...
public class RMSControllerV1 {
    ...
    public String book(@RequestParam(name = "source") String source,
        @RequestParam(name = "destination") String destination,@RequestParam(name = "date")Date date,@RequestParam(name = "personname") String name) {
    ...
    public ReservationInfo book(@RequestParam(name = "reservationId") String reservationId) {
        ReservationInfo info = bookingService.getReservationInfo(reservationId);
        return info;
    }
